// docs-en.js
// English (EN) — data + localized UI strings

const docs = [
  { id: 'proforma', title: 'Proforma Invoice (Template)', desc: 'Standard commercial proforma invoice', cat: 'commercial', file: '/assets/docs/Proforma_Invoice_Template.docx', ext: 'docx' },
  { id: 'invoice', title: 'Commercial Invoice (Template)', desc: 'Commercial invoice for export', cat: 'commercial', file: '/assets/docs/Commercial_Invoice_Template.docx', ext: 'docx' },
  { id: 'packing', title: 'Packing List (Template)', desc: 'Standard packing list template', cat: 'logistics', file: '/assets/docs/Packing_List_Template.xlsx', ext: 'xlsx' },
  { id: 'contract', title: 'International Contract', desc: 'Basic international sale & purchase contract', cat: 'contracts', file: '/assets/docs/International_Contract.docx', ext: 'docx' },
  { id: 'checklist', title: 'Export Checklist', desc: 'Quick export readiness checklist', cat: 'guides', file: '/assets/docs/Export_Checklist.pdf', ext: 'pdf' }
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (kitBtn) {
    kitBtn.addEventListener("click", async () => {
      ...
      const a = document.createElement("a"); a.href = zip; a.download = "BrazilTrad_Export_Kit.zip"; document.body.appendChild(a); a.click(); a.remove();
